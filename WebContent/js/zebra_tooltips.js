	...
	e.Zebra_Tooltips = function(k, p) {
		...
		var n = function(c) {
				...
				if (a.window_resized || a.window_scrolled) d = e(window), a.window_resized && (l = d.width(), u = d.height(), g = c.offset(), e.extend(a, {
					...
					tooltip_top: g,
					arrow_left: f
				}), a.window_resized = !1, a.window_scrolled = !1, a = e.extend(c.data("Zebra_Tooltip"), a), c.data("Zebra_Tooltip", a);
				return a
			},
			m = function(c) {
				var a = c.data("Zebra_Tooltip");
		...
		(function() {
			...
			k.each(function() {
				...
				if (a && "" !== a || d && "" !== d || void 0 !== b.settings.content) c.bind({
					...
					destroy: !1,
					muted: !1
				}), c.attr("title", ""), b.settings.prerender && n(c)
			});
